...
with block:
    ...
    with gr.Row():
        ...
        submit = gr.Button(value="Send", variant="secondary").style(scale=1)
    ...
    openai_api_key_textbox = os.getenv("OPENAI_API_KEY")

    chain = set_openai_api_key(openai_api_key_textbox)
